    ...
    protected function parseResponse($message_code, $message = '')
    {
        ...
        switch ($message_code) {
            ...
            case Api\Pb\Message::RpbPutResp:
                ...
                $this->response = new Command\DataObject\Response($this->success, $code, '', $location, $objects);
                break;
            ...
            case Api\Pb\Message::RpbGetBucketKeyPreflistResp:
                ...
                $this->response = new Command\DataObject\Response($this->success, $code, '', $location, [new DataObject($preflist)]);
                break;
            /** @noinspection PhpMissingBreakStatementInspection */
